# -*- coding: utf-8 -*-
"""Cuadros y gráficos estadísticos   Error cuadrático medio_177735.ipynb
Gerardo Gael Elias Delgadillo_177735
Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1p42y_jgmAt5FuMSioXLdGATxWZ9pA0OR
...
Pct = [0.688,0.688,0.563,0.250,0.125,0.688,0.625,0.438,0.313,0.688,0.625,0.500,00.438,0.125,0.813,0.688,0.563,0.375,0.250,0.688,0.563,0.313,0.313,0.313,0.875,0.750,0.375,0.375]
...
# Crear la ojiva menor que
plt.plot(bin_centers, frecuencia_acumulada, marker='o')
plt.title('Ojiva Menor que de porcentajes de juegos ganados')
plt.xlabel('Temperatura (°C)')
plt.ylabel('Frecuencia Acumulada')
plt.grid(True)
plt.show()